...
//
// strongly inspired, adapted, and taken from the three.js's Matrix4 implementation that is under the MIT license [1]
//
// [1] https://github.com/mrdoob/three.js/blob/dev/src/math/Matrix4.js
//
...
class Matrix4{
	...
	getInverse(){
		...
		if (det === 0 ){
			let msg = "Matrix4: .invert() can't invert matrix, determinant is 0";
